      ...
      <div className="bg-white dark:bg-slate-surface w-full max-w-md rounded-3xl p-8 shadow-2xl">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full bg-cream dark:bg-slate-800 hover:bg-teal-700 hover:text-white dark:hover:bg-teal-700 text-charcoal dark:text-white p-4 rounded-2xl font-medium transition-all text-left"
          >
