...
export function EditListModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-slate-surface w-full max-w-lg rounded-3xl p-8 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full min-h-[90px] bg-cream dark:bg-slate-800 border-none rounded-2xl px-6 py-4 text-base outline-none focus:ring-2 ring-teal-700 dark:text-white resize-none"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-500 mb-2">
            ...
            <textarea
              ...
              className="w-full min-h-[120px] bg-cream dark:bg-slate-800 border-none rounded-2xl px-6 py-4 text-base outline-none focus:ring-2 ring-teal-700 dark:text-white resize-none"
            />
          ...
          <button
            ...
            className="w-full bg-teal-700 text-white py-4 rounded-2xl font-bold hover:bg-teal-800 disabled:opacity-50 flex items-center justify-center gap-2"
          >
            <Save size={18} />
